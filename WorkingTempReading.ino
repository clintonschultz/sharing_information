...
void setup() {
  ...
  sensor0.setHighTempF(80.0);  // set T_HIGH in F
  //sensor0.setHighTempC(29.4); // set T_HIGH in C
  
  //set T_LOW, the lower limit to shut turn off the alert
  sensor0.setLowTempF(70.0);  // set T_LOW in F
...
void loop()
{
  ...
  lcd.setCursor(15,0);
for (int positionCounter1 = 0; positionCounter1 < 4; positionCounter1++){
